...
export default function Home() {
  const features = [
    {
      ...
      description: "Get intelligent suggestions and optimization recommendations powered by Google's Gemini AI"
    },
    {
      icon: FileText,
      title: "Rich Prompt Editor",
      description: "Intuitive editor with real-time preview, character counting, and formatting tools"
    },
    {
      icon: Palette,
  ...
  const testimonials = [
    {
      ...
      content: "This tool has revolutionized how I create prompts. The AI suggestions are incredibly helpful and have improved my content quality by 300%.",
      rating: 5,
    ...
    },
    {
      ...
      content: "The template system and code review prompts have streamlined our development process. It's like having an AI assistant that understands our workflow.",
      rating: 5,
    ...
    },
    {
      ...
      company: "University",
      content: "The analytical prompts and scoring system help me create more effective research queries. It's an invaluable tool for academic work.",
      rating: 5,
  ...
  const blogPosts = [
    {
      ...
      excerpt: "Learn the essential techniques for creating effective AI prompts that deliver consistent, high-quality results.",
      date: "Dec 15, 2024",
      readTime: "5 min read",
      category: "Tutorial",
    ...
    },
    {
      ...
      excerpt: "Explore the latest trends in AI-powered content creation and how professionals are leveraging these tools.",
      date: "Dec 12, 2024",
      readTime: "7 min read",
      category: "Industry",
    ...
    },
    {
      ...
      excerpt: "See how a marketing agency used our platform to dramatically improve their content creation process.",
      date: "Dec 10, 2024",
      readTime: "4 min read",
      category: "Case Study",
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="#showcase" className="text-sm font-medium hover:text-primary transition-colors">Use Cases</Link>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
        ...
        <div className="container mx-auto px-4 py-24 relative">
          ...
          >
            ...
            >
              Create, optimize, and manage AI prompts with intelligent suggestions. 
      ...
      <AnimatedSection className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl font-bold mb-6">Empowering Everyone to Master AI Communication</h2>
            <p className="text-xl text-muted-foreground mb-12 leading-relaxed">
              We believe that effective AI communication shouldn't be limited to experts. Our platform democratizes 
              prompt engineering, making it accessible to creators, professionals, and businesses of all sizes.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground">Create prompts that deliver exactly what you need, every time.</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground">Stay ahead with cutting-edge AI enhancement technology.</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground">Join thousands of creators sharing knowledge and best practices.</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      {/* Features Section */}
      <AnimatedSection id="features" className="py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge variant="outline" className="mb-4">Features</Badge>
            <h2 className="text-4xl font-bold mb-6">Everything You Need to Create Perfect Prompts</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Powerful tools and intelligent features designed to help you craft, optimize, and manage AI prompts like a pro.
            </p>
          </div>
      ...
      <AnimatedSection id="showcase" className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge variant="outline" className="mb-4">Use Cases</Badge>
            <h2 className="text-4xl font-bold mb-6">Perfect for Every Industry</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              From creative writing to business strategy, our platform adapts to your specific needs and workflow.
            </p>
          </div>
            ...
            {useCases.map((useCase, index) => (
              <motion.div key={index} variants={fadeInUp}>
                <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer">
                  <CardContent className="p-8">
                    <div className={`w-16 h-16 ${useCase.color} rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
      ...
      {/* Pricing Section */}
      <AnimatedSection id="pricing" className="py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
      ...
      {/* Blog Section */}
      <AnimatedSection id="blog" className="py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge variant="outline" className="mb-4">Blog</Badge>
            <h2 className="text-4xl font-bold mb-6">Latest Insights & Updates</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Stay updated with the latest trends, tips, and best practices in AI prompt engineering.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
              Join thousands of professionals who are already creating better AI prompts with PromptCraft.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Empowering everyone to create perfect AI prompts with intelligent tools and professional templates.
              </p>
              <div className="flex gap-4">
