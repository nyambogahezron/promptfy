...
// Custom drawer content component moved outside to avoid nested component definition
function CustomDrawerContent(props: DrawerContentComponentProps) {
	...
	return (
		<View style={[styles.drawerContainer, { backgroundColor: colorScheme.cardBackground }]}>
			...
			{recentPrompts.length > 0 && (
				<View style={styles.recentPromptsSection}>
					<View style={styles.recentPromptsHeader}>
						...
						<Text style={[styles.recentPromptsTitle, { color: colorScheme.text }]}>
							Recent Prompts
						</Text>
					</View>
					<FlatList
						...
						renderItem={({ item }) => (
							<TouchableOpacity
								style={[styles.promptItem, { borderColor: colorScheme.border }]}
								onPress={() => {
							...
							>
								<Text
									style={[styles.promptText, { color: colorScheme.secondaryText }]}
									numberOfLines={1}
									ellipsizeMode="tail"
								>
									{item.content}
			...
			<View style={styles.bottomSection}>
				...
				>
					...
					<Text style={[styles.bottomButtonText, { color: colorScheme.text }]}>Settings</Text>
				</TouchableOpacity>
			</View>
		</View>
	);
