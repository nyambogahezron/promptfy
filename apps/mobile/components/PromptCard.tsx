import { Bookmark, BookmarkCheck, Calendar, Copy, Trash2 } from "lucide-react-native";
		...
		>
			<View style={styles.promptHeader}>
				...
				<View style={styles.promptActions}>
					<TouchableOpacity style={styles.promptAction} onPress={onToggleSave}>
						{item.saved ? (
					...
					<TouchableOpacity style={styles.promptAction} onPress={onCopy}>
						<Copy size={18} color={colorScheme.secondaryText} />
					</TouchableOpacity>
					<TouchableOpacity style={styles.promptAction} onPress={onRemove}>
