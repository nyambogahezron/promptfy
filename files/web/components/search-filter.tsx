...
export function SearchFilter({
  ...
  const hasActiveFilters = selectedCategory !== 'all' || selectedTags.length > 0 || showFavoritesOnly;
  ...
  return (
    <div className="space-y-4">
      ...
      {hasActiveFilters && (
        ...
        >
          Active filters: {selectedCategory !== 'all' && categories.find(c => c.id === selectedCategory)?.name}
