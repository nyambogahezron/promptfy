...
export const promptTemplates: PromptTemplate[] = [
  {
    ...
    content: 'Write a compelling [GENRE] story about [MAIN_CHARACTER] who faces [CONFLICT]. Include vivid descriptions, engaging dialogue, and a satisfying resolution. Target length: [LENGTH] words.',
    category: 'creative',
  ...
  },
  {
    ...
    content: 'Analyze the following business scenario and provide strategic recommendations:\n\nCompany: [COMPANY_NAME]\nIndustry: [INDUSTRY]\nChallenge: [CHALLENGE]\n\nProvide:\n1. SWOT analysis\n2. Market opportunities\n3. Actionable recommendations\n4. Risk assessment',
    category: 'business',
  ...
  },
  {
    ...
    content: 'Create comprehensive educational content about [TOPIC] for [TARGET_AUDIENCE].\n\nInclude:\n1. Learning objectives\n2. Key concepts with examples\n3. Interactive exercises\n4. Assessment questions\n5. Additional resources\n\nMake it engaging and age-appropriate.',
    category: 'education',
  ...
  },
  {
    ...
    content: 'Create compelling marketing content for [PRODUCT/SERVICE]:\n\nTarget audience: [AUDIENCE]\nPlatform: [PLATFORM]\nGoal: [MARKETING_GOAL]\n\nGenerate:\n1. Engaging headline options\n2. Value proposition\n3. Call-to-action\n4. Hashtags/keywords\n5. Content calendar suggestions',
    category: 'marketing',
